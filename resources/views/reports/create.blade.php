...
@section('title', 'Buat Laporan Medis Baru')
    ...
    <div class="animate-fade-in">
        ...
        <div class="bg-beige rounded-xl shadow-lg p-4 sm:p-6 mb-6">
            <div class="flex items-center space-x-3">
                <a href="{{ route('reports.index') }}" class="text-terracotta hover:text-maroon transition-colors duration-200">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </a>
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-maroon">Buat Laporan Medis Baru</h1>
                    <p class="text-terracotta text-sm sm:text-base">Isi formulir di bawah untuk membuat laporan medis</p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-cream rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 mb-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div class="col-span-full mt-4">
                        <label for="signature" class="block text-sm font-medium text-maroon mb-2">Upload Tanda Tangan <span class="text-terracotta">*</span></label>
